...
<head>
  ...
  <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('lio90.png') }}">
   ...
   <style>
    :root {
      --primary-color: #d8b4a0;    /* Soft Beige */
      --secondary-color: #4a6670;  /* Muted Blue/Gray */
      --accent-color: #d0a98f;     /* Soft Gold */
      --dark-color: #2d3748;       /* Charcoal */
      --light-color: #f8f5f2;      /* Off White */
      --brown-color: #4a2c1a;      /* Rich Brown */
      --gold-color: #d4af37;       /* Rich Gold */
    }
    ...
    .explore-button::before {
      ...
      background: rgba(212, 175, 55, 0.3); /* Fallback for older browsers */
    }
