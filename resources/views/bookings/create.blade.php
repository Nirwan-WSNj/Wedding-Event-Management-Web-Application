...
<section class="py-24 bg-gradient-to-b from-[#fef8f5] to-white">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <h2 class="text-4xl font-bold text-[#333] mb-6">Create Booking</h2>
        <div class="bg-white shadow-md rounded-xl p-8 max-w-lg mx-auto">
            <form method="POST" action="{{ route('bookings.store') }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="date" name="event_date" value="{{ old('event_date') }}" class="form-input w-full" required>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="hall_name" value="{{ old('hall_name') }}" class="form-input w-full" required>
                ...
                <div class="mb-4">
                    ...
                    <input type="number" step="0.01" name="package_price" value="{{ old('package_price') }}" class="form-input w-full" required>
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="guest_count" value="{{ old('guest_count') }}" class="form-input w-full" required>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="customization_decorations_additional" class="form-input w-full">{{ old('customization_decorations_additional') }}</textarea>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="customization_catering_custom" class="form-input w-full">{{ old('customization_catering_custom') }}</textarea>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="customization_additional_services_selected" class="form-input w-full">{{ old('customization_additional_services_selected') }}</textarea>
                ...
                <div class="flex justify-between mt-6">
                    ...
                    <button type="submit" class="px-6 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">Create Booking</button>
                </div>
            </form>
        </div>
    </div>
