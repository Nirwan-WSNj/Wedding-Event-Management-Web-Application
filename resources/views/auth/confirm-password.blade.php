...
<head>
  ...
  <title>Confirm Password - Wedding Planner</title>
...
<body class="min-h-screen flex items-center justify-center px-4">
  <div class="form-container">
    <h2 class="text-2xl font-semibold text-gray-800 mb-2">Confirm Password</h2>
    <p class="text-gray-600 mb-6">This is a secure area of the application. Please confirm your password before continuing.</p>
    ...
    <form method="POST" action="{{ route('password.confirm') }}">
      ...
      <button type="submit" class="w-full bg-primary text-white py-2 px-4 rounded-button font-medium hover:bg-primary/90 transition">Confirm</button>
    </form>

    <div class="mt-5 text-center text-sm text-gray-600">
      <a href="{{ route('home') }}" class="text-primary font-medium hover:underline">Back to Home</a>
    </div>
  </div>
</body>
</html>
